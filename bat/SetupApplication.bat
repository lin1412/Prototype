...
:: Android packaging
set AND_CERT_NAME="Prototype"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Prototype.p12
...
set IOS_PROVISION=cert\Prototype.mobileprovision
...
set APP_ID=air.Prototype

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Prototype
